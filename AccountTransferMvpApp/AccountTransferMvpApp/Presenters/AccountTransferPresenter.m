...
- (id)initWithRemote:(id <IRemoteAccountRepository>)remoteAccountRepository
            andLocal:(id <ILocalAccountRepository>)localAccountRepository {
    if (self = [super init]) {
...
- (void)transferAmount {
    ...
    [_accountTransferView setDisplayMessage:@"$150.0 transferred."];
}
@end