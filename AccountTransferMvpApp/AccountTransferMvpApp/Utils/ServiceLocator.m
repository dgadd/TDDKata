...
+ (id)createAccountTransferPresenter {
    ...
    AccountTransferPresenter *accountTransferPresenter = [[AccountTransferPresenter alloc] initWithRemote:remoteAccountRepository andLocal:localAccountRepository];
