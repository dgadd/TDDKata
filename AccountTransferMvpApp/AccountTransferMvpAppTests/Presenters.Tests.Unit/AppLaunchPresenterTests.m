...
-(void)test_whenSetupMethodIsCalled_thenDelegatedRepositoryMethodsAreCalled {
    ...
    AppLaunchPresenter *sut = [[AppLaunchPresenter alloc] initWithMap:mapLocationRepository
                                                         andAdManager:adManagerRepository];
    [sut setup];
